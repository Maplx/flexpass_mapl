...
adj1 = Adjustment1(trial=21, n_apps=5, T=50, links=range(30),
                         max_n_states=8, max_n_flows=8, max_n_flow_hop=5,
                         verbose=False)
adj1.run()


print('transition time: ',adj1.transition_times)
print('average flex:', sum(adj1.flex_l)/len(adj1.flex_l))
print('average flex:', sum(adj1.flex_l)/adj1.transition_times)
print('average time: ', sum(adj1.time_l)/adj1.transition_times)
print('average reconfiguration per 100:',adj1.reconf_l[-1]/adj1.transition_times * 100)
print('frequency of infeasible state: ', adj1.infeasible_times/adj1.transition_times * 100, '%')
