...
adj3 = Adjustment3(trial=21, n_apps=5, T=50, links=range(30),
                         max_n_states=8, max_n_flows=8, max_n_flow_hop=5,
                         verbose=False)
adj3.run()


print('transition time: ',adj3.transition_times)
print('average flex:', sum(adj3.flex_l)/len(adj3.flex_l))
print('average flex:', sum(adj3.flex_l)/adj3.transition_times)
print('average time: ', sum(adj3.time_l)/adj3.transition_times)
print('average reconfiguration per 100:',adj3.reconf_l[-1]/adj3.transition_times * 100)
print('frequency of infeasible state: ', adj3.infeasible_times/adj3.transition_times * 100, '%')