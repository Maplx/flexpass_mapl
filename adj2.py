...
adj2 = Adjustment2(trial=21, n_apps=5, T=50, links=range(30),
                         max_n_states=8, max_n_flows=8, max_n_flow_hop=5,
                         verbose=False)
adj2.run()


print('transition time: ',adj2.transition_times)
print('average flex:', sum(adj2.flex_l)/len(adj2.flex_l))
print('average flex:', sum(adj2.flex_l)/adj2.transition_times)
print('average time: ', sum(adj2.time_l)/adj2.transition_times)
print('average reconfiguration per 100:',adj2.reconf_l[-1]/adj2.transition_times * 100)
print('frequency of infeasible state: ', adj2.infeasible_times/adj2.transition_times * 100, '%')